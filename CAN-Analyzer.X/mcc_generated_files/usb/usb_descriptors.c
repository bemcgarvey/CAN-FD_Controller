...
const uint8_t configDescriptor1[] = {
    ...
    39, 0x00, // Total length of data for this cfg
...
const MS_EXT_PROPERTY_FEATURE_DESC ExtPropertyFeatureDescriptor ={
    ...
    {'{', 'f', '6', '8', 'f', 'b', '9', '7', '2', '-', 'c', '0', '7', 'f', '-', '4', 'e', '6', '1', '-', '8', '7', 'a', '1', '-', 'f', '5', 'a', '5', 'f', 'e', '9', '3', 'f', 'd', '0', 'c', '}', 0x0000} //bPropertyData - this is the actual GUID value.  Make sure this matches the PC application code trying to connect to the device.
};
#endif
